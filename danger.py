...
def create_inline_keyboard():
    ...
    markup.add(types.InlineKeyboardButton("❤️ Join Our Channel", url="https://t.me/kadamisback1"))
    markup.add(types.InlineKeyboardButton("👤 Contact Owner", url="https://t.me/kadamisback"))
    return markup
...
def get_price_list():
    ...
    return ("*💰 Credit Packages 💰*\n\n" +
            ...
            "\n\n*📩 Contact @kadamisback to purchase*")
...
def rules_command(message):
    rules_text = (
        ...
        "6. Report issues! 🛡️ \nMessage @kadamisback for any problems.\n\n"
